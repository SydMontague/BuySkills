...
// TODO rewrite to a more dynamic system - maybe an Enum?
/**
 ...
 * {
 * public static String GRANT_NOT_AFFORD;
 ...
 * config.getString("string.COMMAND_PLAYER_NOT_EXIST");
 ...
 * config.getString("string.HELP_COMMAND_RECALCULATE");
 ...
 * config.getString("string.BUYRENT_SKILLCAP_REACHED");
 ...
 * GRANT_NOT_AFFORD = config.getString("string.GRANT_NOT_AFFORD");
 * }
 * }
 */
