...
{
    // TODO Stringloader and default Strings!
    ...
    public static String SKILL_RENT_EXPIRED;
    public static String PLAYER_NOT_OWN;
    public static String REVOKE_SUCCESS;
    public static String SKILL_NOT_BUYABLE;
    public static String SKILLCAP_REACHED;
    public static String BUY_ALREADY_OWN;
    public static String BUY_NOT_REQUIREMENT;
    public static String BUY_NOT_PERMISSION;
    public static String BUY_NOT_GROUP;
    public static String BUY_NOT_SKILLTREE;
    public static String BUY_NOT_AFFORD;
